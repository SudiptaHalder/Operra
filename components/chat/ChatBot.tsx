...
//     {
//       id: '1',
//       text: "Hi there! 👋 I'm Operra's virtual assistant. How can I help you today?",
//       sender: 'bot',
//       timestamp: new Date(),
//       options: [
//         'Product information',
...
//         setTimeout(() => {
//           addMessage(
//             "Hi there! I'm Sarah 👋 Thanks for reaching out. I see you're interested in learning more about Operra. How can I help you today?",
//             'agent'
//           )
//         }, 2000)
//       }, 3000)
...
//         setTimeout(() => {
//           addMessage(
//             "Hello! I'm Mike from sales. Thanks for your interest in Operra. How can I assist you today?",
//             'agent'
//           )
//         }, 2000)
//       }, 1500)
...
//                     {chatState === 'human' ? 'Sarah (Sales)' : 'Operra Assistant'}
//                   </h3>
...
export default function ChatBot() {
  ...
  const handleBotResponse = (userMessage: string) => {
    ...
    // Greetings
      ...
      simulateTyping(
        "Hello! 👋 How can I assist you with Operra today?",
    ...
    // Default response
      ...
      simulateTyping(
        "I'm here to help with questions about Operra! You can ask me about:\n\n• Products and features\n• Pricing and plans\n• Booking a demo\n• Support options\n\nWhat would you like to know?",
  ...
  const handleOptionClick = (option: string) => {
    ...
    if (option === 'Book demo now' || option === 'Book a demo') {
      ...
      window.open('https://help.operra.com', '_blank')
      setTimeout(() => {
      ...
      window.location.href = 'mailto:support@operra.com'
      setTimeout(() => {
          ...
          <div className="bg-gradient-to-r from-purple-600 to-pink-600 text-white p-4 flex-shrink-0">
            <div className="flex justify-between items-center">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="font-semibold">Operra Assistant</h3>
