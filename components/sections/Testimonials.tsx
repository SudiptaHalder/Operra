...
// Customer names are intentionally distinct from internal staff names
// (Alex Rivera, Maya Patel, James Chen, Sarah Okonkwo) to avoid credibility overlap.
const testimonials = [
  {
    content: "We were managing everything in spreadsheets. Trezbo saved us hours every week and gave us back time to focus on our customers.",
    author: "Priya Nair",
    role: "Owner, Nair Organic Foods",
    rating: 5,
    industry: "Retail",
    initials: "PN",
  },
  {
    content: "The vendor management feature alone is worth it. We have not missed a single contract renewal since switching to Trezbo.",
    author: "Tom Whitfield",
    role: "Founder, Whitfield Plumbing",
    rating: 5,
    industry: "Construction",
    initials: "TW",
  },
  {
    content: "Simple, affordable, and exactly what we needed. No enterprise complexity — just the features we actually use every day.",
    author: "Anita Desouza",
    role: "Director, Desouza Digital",
    rating: 5,
    industry: "Marketing",
    initials: "AD",
  },
  {
    content: "Payroll used to take me half a day. Now it is 30 minutes. My team loves the leave tracking and the dashboard.",
    author: "Robert Mensah",
    role: "Owner, Mensah Landscaping",
    rating: 5,
  ...
  return (
    <section className="py-24 relative overflow-hidden">
      ...
      <div className="relative mx-auto max-w-7xl px-6 lg:px-8">
          ...
          {testimonials.map((testimonial, index) => (
            ...
            >
              ...
              <div className="mt-6 flex items-center gap-4">
                ...
                <span
                  className="ml-auto text-xs font-medium px-3 py-1 rounded-full border flex-shrink-0"
                  style={{
                    color: '#982598',
                    borderColor: '#98259825',
                    backgroundColor: '#98259808',
                  }}
                >
        ...
        {/* Industry tags */}
        <div className="mt-16 flex flex-wrap justify-center gap-3 items-center">
          {['Retail', 'Construction', 'Marketing', 'Healthcare', 'Tech', 'Hospitality'].map((industry) => (
            <span
              key={industry}
              className="text-sm font-medium px-4 py-2 rounded-full border"
